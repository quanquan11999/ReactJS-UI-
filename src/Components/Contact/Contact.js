      ...
      <div className="row justify-content-between">
        <div className="col-lg-5">
          <div className="intro-excerpt">
            <h1>Liên Hệ</h1>
            <p className="mb-4">
            Hãy liên hệ với Decor Tech để chúng tôi có thể tư vấn trực tiếp cho bạn về sản phẩm và dịch vụ bạn quan tâm. 
              ...
              <div className="col-lg-4">
                ...
                >
                  ...
                  <div className="service-contents">
                    <p>25 đường nguyễn thị chạy, Khu phố chiêu liêu, phường tân đông hiệp, dĩ an , bình dương</p>
                  </div>{" "}
                  {/* /.service-contents*/}
                </div>{" "}
                {/* /.service */}
